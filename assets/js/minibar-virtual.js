...
function cambiarIdioma(idioma) {
  var url;
      if (idioma === 'es') {
          url = 'index.html'; // archivo HTML en español
      } else if (idioma === 'en') {
          url = 'index_en.html'; // archivo HTML en inglés
      }
      window.location.href = url; // redireccionar a la página del idioma seleccionado
}